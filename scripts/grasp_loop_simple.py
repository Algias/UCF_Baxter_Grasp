...
def grapser_loop():
    ...
    pose_kinect.header.frame_id = "world"
    pose_kinect.pose.position.x = -.1
    pose_kinect.pose.position.y = -0.5
    pose_kinect.pose.position.z = -.55
    ...
    scene.add_box("kinect", pose_kinect, size=(.5, 1, .5))
