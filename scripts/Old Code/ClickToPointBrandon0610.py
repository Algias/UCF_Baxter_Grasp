...
def calculatePose(point1,point2,point3):
        ...
        pose_n.pose.position.x = (point1[0] + point2[0] + point3[0])/3
        pose_n.pose.position.y = (point1[1] + point2[1] + point3[1])/3
        pose_n.pose.position.z = (point1[2] + point2[2] + point3[2])/3
