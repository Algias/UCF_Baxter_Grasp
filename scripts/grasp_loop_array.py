...
class ReceivePoses:
    ...
    def __init__(self):
        ...
        self.stop_posearray = PoseArray()
        self.final_posearray = PoseArray()
    ...
    def listen(self):
        ...
        rospy.Subscriber("/myposearray1", PoseArray, self.callback3)
        rospy.Subscriber("/myposearray2", PoseArray, self.callback4)
        rospy.sleep(0.2)
        
    def callback2(self, data):
        self.final_pose = data;
    def callback3(self, data):
        self.final_posearray = data;
    def callback4(self, data):
        self.stop_posearray = data;
